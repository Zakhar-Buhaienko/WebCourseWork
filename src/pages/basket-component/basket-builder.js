...
import BookText4 from '../../data/books/1004-book';
import BookText5 from '../../data/books/1005-book';
import BookText6 from '../../data/books/1006-book';
import BookText7 from '../../data/books/1007-book';
...
const BasketBuilder = (props) => {
    ...
    const removeItem = () => {
        ...
        if (storedDataCounters[idItem - 1] > 0) {
            const updatedItems = storedDataItems.filter(item => item.id !== props.card.id || storedDataCounters[idItem - 1] > 1);
            let foundItemIndex;
        ...
        <div className="col-12 my-3">
            <Card className="h-100 text-dark bg-light">
                ...
                <Card.Footer className="d-flex justify-content-between align-items-center">
                    ...
                    <span>
                        Sum {storedDataCounters[idItem - 1] * props.card.price} UAH,
                        Selected {storedDataCounters[idItem - 1]}
                    </span>
                </Card.Footer>
            </Card>
        </div>
